"use strict";var Ut=Object.create;var G=Object.defineProperty;var xt=Object.getOwnPropertyDescriptor;var wt=Object.getOwnPropertyNames;var Ft=Object.getPrototypeOf,kt=Object.prototype.hasOwnProperty;var $t=(r,e)=>{for(var t in e)G(r,t,{get:e[t],enumerable:!0})},Re=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of wt(e))!kt.call(r,n)&&n!==t&&G(r,n,{get:()=>e[n],enumerable:!(s=xt(e,n))||s.enumerable});return r};var X=(r,e,t)=>(t=r!=null?Ut(Ft(r)):{},Re(e||!r||!r.__esModule?G(t,"default",{value:r,enumerable:!0}):t,r)),Pt=r=>Re(G({},"__esModule",{value:!0}),r);var As={};$t(As,{generateContext:()=>Se});module.exports=Pt(As);var Dt=X(require("path"),1),vt=require("os"),yt=require("fs");var oe=require("bun:sqlite");var T=require("path"),ee=require("os"),D=require("fs");var Ae=require("url");var L=require("fs"),he=require("path");var Ht=null;function Gt(r){return(Ht??process.stderr.write.bind(process.stderr))(r)}function z(r){Gt(r)}var j=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(j||{}),Z=class r{level=null;recentLogs=[];static MAX_RECENT_LOGS=5e3;forwardBuffer=[];static MAX_FORWARD_BUFFER=500;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=x.logsDir();(0,L.existsSync)(e)||(0,L.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0],n=process.env.CLAUDE_MEM_CONTAINER_MODE==="worker"?`claude-mem-worker-${t}.log`:`claude-mem-${t}.log`;this.logFilePath=(0,he.join)(e,n)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=x.settings();if((0,L.existsSync)(e)){let t=(0,L.readFileSync)(e,"utf-8"),n=(JSON.parse(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=j[n]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}forwardLevelThreshold(){let e=(process.env.CLAUDE_MEM_LOG_FORWARD_LEVEL??"WARN").toUpperCase(),t=j[e];return typeof t=="number"?t:2}drainForwardBuffer(){let e=this.forwardBuffer;return this.forwardBuffer=[],e}correlationId(e,t){return`obs-${e}-${t}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
...
`+JSON.stringify(o,null,2)}catch{c=" "+this.formatData(o)}else c=" "+this.formatData(o);let p="";if(n){let{sessionId:m,memorySessionId:f,correlationId:b,...E}=n;Object.keys(E).length>0&&(p=` {${Object.entries(E).map(([O,S])=>`${O}=${S}`).join(", ")}}`)}let g=`[${i}] [${a}] [${d}] [${this.ownSource.padEnd(6)}] ${l}${s}${p}${c}`;if(this.recentLogs.push(g),this.recentLogs.length>r.MAX_RECENT_LOGS&&this.recentLogs.splice(0,this.recentLogs.length-r.MAX_RECENT_LOGS),e>=this.forwardLevelThreshold()&&(this.forwardBuffer.push(g),this.forwardBuffer.length>r.MAX_FORWARD_BUFFER&&this.forwardBuffer.splice(0,this.forwardBuffer.length-r.MAX_FORWARD_BUFFER)),this.logFilePath)try{(0,L.appendFileSync)(this.logFilePath,g+`
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),c=l?`${l[1].split("/").pop()}:${l[2]}`:"unknown",p={...s,location:c};return this.warn(e,`[HAPPY-PATH] ${t}`,p,n),o}},u=new Z;var zt={};function Xt(){return typeof __dirname<"u"?__dirname:(0,T.dirname)((0,Ae.fileURLToPath)(zt.url))}var jt=Xt();function Bt(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let r=(0,T.join)((0,ee.homedir)(),".claude-mem"),e=(0,T.join)(r,"settings.json");try{if((0,D.existsSync)(e)){let t=JSON.parse((0,D.readFileSync)(e,"utf-8")),s=t.env??t;if(s.CLAUDE_MEM_DATA_DIR)return s.CLAUDE_MEM_DATA_DIR}}catch{}return r}var R=Bt(),v=process.env.CLAUDE_CONFIG_DIR||(0,T.join)((0,ee.homedir)(),".claude"),ys=(0,T.join)(v,"plugins","marketplaces","bjlee2024"),Wt=(0,T.join)(R,"archives"),Vt=(0,T.join)(R,"logs"),Kt=(0,T.join)(R,"trash"),Yt=(0,T.join)(R,"backups"),qt=(0,T.join)(R,"modes"),Jt=(0,T.join)(R,"settings.json"),Ce=(0,T.join)(R,"claude-mem.db"),Qt=(0,T.join)(R,"vector-db"),Ie=(0,T.join)(R,"observer-sessions"),te=(0,T.basename)(Ie),Us=(0,T.join)(v,"settings.json"),xs=(0,T.join)(v,"commands"),ws=(0,T.join)(v,"CLAUDE.md");function Ne(r){(0,D.mkdirSync)(r,{recursive:!0})}function Le(){return(0,T.join)(jt,"..")}var x={dataDir:()=>R,workerPid:()=>(0,T.join)(R,"worker.pid"),serverBetaPid:()=>(0,T.join)(R,".server-beta.pid"),serverBetaPort:()=>(0,T.join)(R,".server-beta.port"),serverBetaRuntime:()=>(0,T.join)(R,".server-beta.runtime.json"),settings:()=>(0,T.join)(R,"settings.json"),database:()=>(0,T.join)(R,"claude-mem.db"),chroma:()=>(0,T.join)(R,"chroma"),combinedCerts:()=>(0,T.join)(R,"combined_certs.pem"),transcriptsConfig:()=>(0,T.join)(R,"transcript-watch.json"),transcriptsState:()=>(0,T.join)(R,"transcript-watch-state.json"),corpora:()=>(0,T.join)(R,"corpora"),supervisorRegistry:()=>(0,T.join)(R,"supervisor.json"),envFile:()=>(0,T.join)(R,".env"),logsDir:()=>Vt,archives:()=>Wt,trash:()=>Kt,backups:()=>Yt,modes:()=>qt,vectorDb:()=>Qt,observerSessions:()=>Ie};var ve=require("crypto");var Me=require("os"),De=X(require("path"),1),se=require("child_process");function Zt(r){return r==="~"||r.startsWith("~/")?r.replace(/^~/,(0,Me.homedir)()):r}function es(r){try{return(0,se.execFileSync)("git",["rev-parse","--show-toplevel"],{cwd:r,encoding:"utf-8",stdio:["ignore","pipe","ignore"]}).trim()||null}catch{return null}}function ts(r){try{return(0,se.execFileSync)("git",["-C",r,"remote","get-url","origin"],{encoding:"utf-8",stdio:["ignore","pipe","ignore"]}).trim()||null}catch{return null}}function ss(r){if(!r||r.trim()==="")return u.warn("PROJECT_NAME","Empty cwd provided, using fallback",{cwd:r}),"unknown-project";let e=Zt(r),t=es(e);if(t){let o=ts(t);if(o){let i=rs(o);if(i)return i}}let s=t??e,n=De.default.basename(s);if(n===""){if(process.platform==="win32"){let i=r.match(/^([A-Z]):\\/i);if(i){let d=`drive-${i[1].toUpperCase()}`;return u.info("PROJECT_NAME","Drive root detected",{cwd:r,projectName:d}),d}}return u.warn("PROJECT_NAME","Root directory detected, using fallback",{cwd:r}),"unknown-project"}return n}function re(r){let e=ss(r);return{primary:e,parent:null,isWorktree:!1,allProjects:[e]}}function rs(r){if(!r)return null;let e=r.trim();e=e.replace(/\.git$/i,""),e=e.replace(/^[a-z]+:\/\//i,"");let t;e.includes(":")&&!e.includes("/")||e.includes(":")&&e.indexOf(":")<e.indexOf("/")?t=e.slice(e.indexOf(":")+1):t=e.slice(e.indexOf("/")+1);let s=t.split("/").filter(Boolean);return s.length<2?null:`${s[s.length-2]}/${s[s.length-1]}`}function B(r,e,t){return(0,ve.createHash)("sha256").update([r||"",e||"",t||""].join("\0")).digest("hex").slice(0,16)}function ne(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[String(e)]}catch{return[r]}}var C="claude";function ns(r){return r.trim().toLowerCase().replace(/\s+/g,"-")}function y(r){if(!r)return C;let e=ns(r);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e.includes("grok")?"grok":e:C}function ye(r){let e=["claude","codex","cursor"];return[...r].sort((t,s)=>{let n=e.indexOf(t),o=e.indexOf(s);return n!==-1||o!==-1?n===-1?1:o===-1?-1:n-o:t.localeCompare(s)})}function os(r,e){return{customTitle:r,platformSource:e?y(e):void 0}}var W=class{db;constructor(e=Ce){e instanceof oe.Database?this.db=e:(e!==":memory:"&&Ne(R),this.db=new oe.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.db.run("PRAGMA journal_size_limit = 4194304")),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.dropDeadPendingMessagesColumns(),this.ensurePendingMessagesToolUseIdColumn(),this.dropWorkerPidColumn(),this.addGitUserColumns()}addGitUserColumns(){let e=this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(33);this.db.query("PRAGMA table_info(observations)").all().some(n=>n.name==="git_user")||(this.db.run("ALTER TABLE observations ADD COLUMN git_user TEXT"),u.debug("DB","Added git_user column to observations table")),this.db.query("PRAGMA table_info(sdk_sessions)").all().some(n=>n.name==="git_user")||(this.db.run("ALTER TABLE sdk_sessions ADD COLUMN git_user TEXT"),u.debug("DB","Added git_user column to sdk_sessions table")),this.db.run("CREATE INDEX IF NOT EXISTS idx_observations_git_user ON observations(git_user)"),e||this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(33,new Date().toISOString())}dropWorkerPidColumn(){let e=this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(32),s=this.db.query("PRAGMA table_info(pending_messages)").all().some(n=>n.name==="worker_pid");if(!(e&&!s)){if(s)try{this.db.run("DROP INDEX IF EXISTS idx_pending_messages_worker_pid"),this.db.run("ALTER TABLE pending_messages DROP COLUMN worker_pid"),u.debug("DB","Dropped worker_pid column and its index from pending_messages")}catch(n){u.warn("DB","Failed to drop worker_pid column from pending_messages",{},n instanceof Error?n:new Error(String(n)));return}e||this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(32,new Date().toISOString())}}dropDeadPendingMessagesColumns(){let e=this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(31),t=this.db.query("PRAGMA table_info(pending_messages)").all(),s=new Set(t.map(i=>i.name)),o=["retry_count","failed_at_epoch","completed_at_epoch"].filter(i=>s.has(i));if(!(e&&o.length===0)){if(o.length>0){this.db.run("BEGIN TRANSACTION");try{this.db.run("DELETE FROM pending_messages WHERE status NOT IN ('pending', 'processing')");for(let i of o)this.db.run(`ALTER TABLE pending_messages DROP COLUMN ${i}`),u.debug("DB",`Dropped dead column ${i} from pending_messages`);e||this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(31,new Date().toISOString()),this.db.run("COMMIT")}catch(i){this.db.run("ROLLBACK"),u.warn("DB","Failed to drop dead columns from pending_messages",{},i instanceof Error?i:new Error(String(i)));return}return}e||this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(31,new Date().toISOString())}}initializeSchema(){this.db.run(`
    ...
    `).all(e)}getAllProjects(e){let t=e?y(e):void 0,s=`
      ...
      WHERE project IS NOT NULL AND project != ''
        AND project != ?
    `,n=[te];return t&&(s+=" AND COALESCE(platform_source, ?) = ?",n.push(C,t)),s+=" ORDER BY project ASC",this.db.prepare(s).all(...n).map(i=>i.project)}getProjectCatalog(){let e=this.db.prepare(`
      SELECT
    ...
    `).all(e)}getObservationById(e){return this.db.prepare(`
      ...
      FROM observations
      WHERE id = ?
    `).get(e)||null}getObservationsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o,type:i,concepts:a,files:d}=t,l=s==="relevance",c=l?"":`ORDER BY created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,p=n?`LIMIT ${n}`:"",g=e.map(()=>"?").join(","),m=[...e],f=[];if(o&&(f.push("project = ?"),m.push(o)),i)if(Array.isArray(i)){let S=i.map(()=>"?").join(",");f.push(`type IN (${S})`),m.push(...i)}else f.push("type = ?"),m.push(i);if(a){let S=Array.isArray(a)?a:[a],h=S.map(()=>"EXISTS (SELECT 1 FROM json_each(concepts) WHERE value = ?)");m.push(...S),f.push(`(${h.join(" OR ")})`)}if(d){let S=Array.isArray(d)?d:[d],h=S.map(()=>"(EXISTS (SELECT 1 FROM json_each(files_read) WHERE value LIKE ?) OR EXISTS (SELECT 1 FROM json_each(files_modified) WHERE value LIKE ?))");S.forEach(M=>{m.push(`%${M}%`,`%${M}%`)}),f.push(`(${h.join(" OR ")})`)}let b=f.length>0?`WHERE id IN (${g}) AND ${f.join(" AND ")}`:`WHERE id IN (${g})`,A=this.db.prepare(`
      SELECT *
      FROM observations
      ${b}
      ${c}
      ${p}
    `).all(...m);if(!l)return A;let O=new Map(A.map(S=>[S.id,S]));return e.map(S=>O.get(S)).filter(S=>!!S)}getSummaryForSession(e){return this.db.prepare(`
      SELECT
        request, investigated, learned, completed, next_steps,
        files_read, files_edited, notes, prompt_number, created_at,
        created_at_epoch
    ...
    `).get(e).count}createSDKSession(e,t,s,n,o,i){let a=new Date,d=a.getTime(),l=os(n,o),c=l.platformSource??C,p=this.db.prepare(`
    ...
    `).get(e);if(p){if(t&&this.db.prepare(`
        ...
        `).run(l.customTitle,e),l.platformSource){let m=p.platform_source?.trim()?y(p.platform_source):void 0;if(!m)this.db.prepare(`
            UPDATE sdk_sessions SET platform_source = ?
            WHERE content_session_id = ?
              AND COALESCE(platform_source, '') = ''
          `).run(l.platformSource,e);else if(m!==l.platformSource)throw new Error(`Platform source conflict for session ${e}: existing=${m}, received=${l.platformSource}`)}return p.id}return this.db.prepare(`
    ...
    `).run(e,t,s,n.toISOString(),o).lastInsertRowid}getUserPrompt(e,t){return this.db.prepare(`
      ...
      LIMIT 1
    `).get(e,t)?.prompt_text??null}storeObservation(e,t,s,n,o=0,i,a){let d=i??Date.now(),l=new Date(d).toISOString(),c=B(e,s.title,s.narrative),g=this.db.prepare(`
    ...
    `).get(e,t,s.type,s.title,s.subtitle,JSON.stringify(s.facts),s.narrative,JSON.stringify(s.concepts),JSON.stringify(s.files_read),JSON.stringify(s.files_modified),n||null,o,s.agent_type??null,s.agent_id??null,s.git_user??null,c,l,d,a||null,s.metadata??null);if(g)return{id:g.id,createdAtEpoch:g.created_at_epoch};let m=this.db.prepare("SELECT id, created_at_epoch FROM observations WHERE memory_session_id = ? AND content_hash = ?").get(e,c);if(!m)throw new Error(`storeObservation: ON CONFLICT without existing row for content_hash=${c}`);return{id:m.id,createdAtEpoch:m.created_at_epoch}}storeSummary(e,t,s,n,o=0,i){let a=i??Date.now(),d=new Date(a).toISOString(),c=this.db.prepare(`
      INSERT INTO session_summaries
      (memory_session_id, project, request, investigated, learned, completed,
       next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,n||null,o,d,a);return{id:Number(c.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,t,s,n,o,i=0,a,d){let l=a??Date.now(),c=new Date(l).toISOString();return this.db.transaction(()=>{let g=[],m=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, agent_type, agent_id, git_user, content_hash, created_at, created_at_epoch,
         generated_by_model)
        ...
        ON CONFLICT(memory_session_id, content_hash) DO NOTHING
        RETURNING id
      `),f=this.db.prepare("SELECT id FROM observations WHERE memory_session_id = ? AND content_hash = ?");for(let E of s){let A=B(e,E.title,E.narrative),O=m.get(e,t,E.type,E.title,E.subtitle,JSON.stringify(E.facts),E.narrative,JSON.stringify(E.concepts),JSON.stringify(E.files_read),JSON.stringify(E.files_modified),o||null,i,E.agent_type??null,E.agent_id??null,E.git_user??null,A,c,l,d||null);if(O){g.push(O.id);continue}let S=f.get(e,A);if(!S)throw new Error(`storeObservations: ON CONFLICT without existing row for content_hash=${A}`);g.push(S.id)}let b=null;if(n){let A=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,o||null,i,c,l);b=Number(A.lastInsertRowid)}return{observationIds:g,summaryId:b,createdAtEpoch:l}})()}storeObservationsAndMarkComplete(e,t,s,n,o,i,a,d=0,l,c){let p=l??Date.now(),g=new Date(p).toISOString();return this.db.transaction(()=>{let f=[],b=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, agent_type, agent_id, git_user, content_hash, created_at, created_at_epoch,
         generated_by_model)
        ...
        ON CONFLICT(memory_session_id, content_hash) DO NOTHING
        RETURNING id
      `),E=this.db.prepare("SELECT id FROM observations WHERE memory_session_id = ? AND content_hash = ?");for(let h of s){let M=B(e,h.title,h.narrative),be=b.get(e,t,h.type,h.title,h.subtitle,JSON.stringify(h.facts),h.narrative,JSON.stringify(h.concepts),JSON.stringify(h.files_read),JSON.stringify(h.files_modified),a||null,d,h.agent_type??null,h.agent_id??null,h.git_user??null,M,g,p,c||null);if(be){f.push(be.id);continue}let Oe=E.get(e,M);if(!Oe)throw new Error(`storeObservationsAndMarkComplete: ON CONFLICT without existing row for content_hash=${M}`);f.push(Oe.id)}let A;if(n){let M=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,a||null,d,g,p);A=Number(M.lastInsertRowid)}if(this.db.prepare(`
        DELETE FROM pending_messages
        WHERE id = ? AND status = 'processing'
      `).run(o).changes!==1)throw new Error(`storeObservationsAndMarkComplete: failed to complete pending message ${o}`);return{observationIds:f,summaryId:A,createdAtEpoch:p}})()}getSessionSummariesByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o}=t,i=s==="relevance",a=i?"":`ORDER BY created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,d=n?`LIMIT ${n}`:"",l=e.map(()=>"?").join(","),c=[...e],p=o?`WHERE id IN (${l}) AND project = ?`:`WHERE id IN (${l})`;o&&c.push(o);let m=this.db.prepare(`
      SELECT * FROM session_summaries
      ${p}
      ${a}
      ${d}
    `).all(...c);if(!i)return m;let f=new Map(m.map(b=>[b.id,b]));return e.map(b=>f.get(b)).filter(b=>!!b)}getUserPromptsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o}=t,i=s==="relevance",a=i?"":`ORDER BY up.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,d=n?`LIMIT ${n}`:"",l=e.map(()=>"?").join(","),c=[...e],p=o?"AND s.project = ?":"";o&&c.push(o);let m=this.db.prepare(`
      SELECT
        up.*,
        s.project,
        s.memory_session_id
      ...
      ${a}
      ${d}
    `).all(...c);if(!i)return m;let f=new Map(m.map(b=>[b.id,b]));return e.map(b=>f.get(b)).filter(b=>!!b)}getTimelineAroundTimestamp(e,t=10,s=10,n){return this.getTimelineAroundObservation(null,e,t,s,n)}getTimelineAroundObservation(e,t,s=10,n=10,o){let i=o?"AND project = ?":"",a=o?[o]:[],d,l;if(e!==null){let E=`
    ...
    ORDER BY o.created_at_epoch DESC
    LIMIT ?
  `).all(e,e,...s,...o,...t.gitUserFilter?[t.gitUserFilter]:[],t.totalObservationCount)}function Ee(r,e,t){return r.db.prepare(`
    SELECT
      ss.id,
    ...
    ORDER BY ss.created_at_epoch DESC
    LIMIT ?
  `).all(e,e,t.sessionCount+_e)}function Ge(r,e,t){let s=Array.from(t.observationTypes),n=s.map(()=>"?").join(","),o=Array.from(t.observationConcepts),i=o.map(()=>"?").join(","),a=e.map(()=>"?").join(","),d=t.gitUserFilter?"AND o.git_user = ?":"";return r.db.prepare(`
    SELECT
      o.id,
      o.memory_session_id,
      COALESCE(s.platform_source, 'claude') as platform_source,
