...
function checkMarketplaceMarker(): void {
  try {
    ...
    const marketplaceCandidates = [
      resolve(home, '.claude', 'plugins', 'marketplaces', 'bjlee2024'),
      resolve(home, '.config', 'claude', 'plugins', 'marketplaces', 'bjlee2024'),
    ];
    const present = marketplaceCandidates.some(p => p && existsSync(p));
    const cacheCandidates = [
      resolve(home, '.claude', 'plugins', 'cache', 'bjlee2024', 'claude-mem'),
      resolve(home, '.config', 'claude', 'plugins', 'cache', 'bjlee2024', 'claude-mem'),
    ];
