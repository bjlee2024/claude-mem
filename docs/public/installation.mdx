...
- Detect your installed IDEs (Claude Code, Cursor, Gemini CLI, Windsurf, OpenCode, Codex CLI, Grok) and let you multi-select which ones to wire up
...
- **Claude Code** or another supported IDE (Cursor, Gemini CLI, Windsurf, OpenCode, Codex CLI, OpenClaw, Grok)
...
See [CHANGELOG](https://github.com/bjlee2024/claude-mem/blob/main/CHANGELOG.md) for complete version history.
