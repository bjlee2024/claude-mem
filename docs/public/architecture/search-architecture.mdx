...
**Location:** `/Users/YOUR_USERNAME/.claude/plugins/marketplaces/bjlee2024/plugin/scripts/mcp-server.cjs`
...
```json
{
  "mcpServers": {
    "mcp-search": {
      "command": "node",
      "args": [
        "/Users/YOUR_USERNAME/.claude/plugins/marketplaces/bjlee2024/plugin/scripts/mcp-server.cjs"
      ]
    }
  }
}
