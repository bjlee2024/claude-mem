...
1. Clear install cache:
   ```bash
   rm ~/.claude/plugins/marketplaces/bjlee2024/.install-version
   ```
...
3. Check version marker:
   ```bash
   cat ~/.claude/plugins/marketplaces/bjlee2024/.install-version
   cat ~/.claude/plugins/marketplaces/bjlee2024/package.json | grep version
   ```
...
3. Check package.json exists:
   ```bash
   ls -la ~/.claude/plugins/marketplaces/bjlee2024/package.json
   ```
...
3. Verify installation:
   ```bash
   ls -la ~/.claude/plugins/marketplaces/bjlee2024/
   ```
...
2. **Create issue**: [GitHub Issues](https://github.com/bjlee2024/claude-mem/issues)
